/*
 * package org.iskon.configuration;
 * 
 ...
 * @Configuration
 * 
 * @ComponentScan(basePackages = { "org.iskon" })
 * 
 ...
 * 
 * @Value("${spring.mail.properties.mail.smtp.port}") private Integer
 * mailServerPort;
 * 
 ...
 * 
 * @Value("${spring.mail.properties.mail.smtp.auth}") private String
 * mailServerAuth;
 * 
 * @Value("${spring.mail.properties.mail.smtp.starttls.enable}") private String
 * mailServerStartTls;
 * 
 ...
 * return message; }
 * 
 * @Bean public ResourceBundleMessageSource emailMessageSource() { final
 * ResourceBundleMessageSource messageSource = new
 * ResourceBundleMessageSource(); messageSource.setBasename("mailMessages");
